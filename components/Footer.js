  ...
  return (
    <footer className="px-4 sm:px-6 lg:px-8 py-10 bg-[#1f1d37] mt-10 w-full">
      <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-8">
        <div>
          ...
          <ul className="space-y-2">
            <li><Link className="text-sm text-white/70 hover:text-white transition-colors" href="/help/faq">{t('home.faq')}</Link></li>
            <li><Link className="text-sm text-white/70 hover:text-white transition-colors" href="/help/payment-options">{t('home.paymentOptions')}</Link></li>
            <li><Link className="text-sm text-white/70 hover:text-white transition-colors" href="/help/contact">{t('home.contactUs')}</Link></li>
          </ul>
        </div>
        <div>
      ...
      <div className="border-t border-white/10 pt-8">
        <h3 className="text-center font-bold text-white mb-6">{t('home.regulationsAndPartners')}</h3>
