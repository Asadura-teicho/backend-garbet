...
function DiceRollPage() {
  ...
  return (
    <ProtectedRoute>
      <div className="relative flex min-h-screen w-full flex-col bg-[#151328]">
                    ...
                    <div className="bg-[#111718] rounded-xl border border-[#3b5054] overflow-hidden">
                      ...
                      <div className="p-6">
                        <div className="grid grid-cols-2 gap-4 mb-6">
                          ...
                          {/* Player 2 */}
                          <div 
                            className={`rounded-xl border-2 p-5 cursor-pointer transition-all transform hover:scale-105 ${
