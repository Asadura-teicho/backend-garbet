...
export const diceRollGameAPI = {
  ...
  // Select winner for PvP game (admin)
  selectPvPWinner: (id, data) => api.patch(`/dice-roll-games/${id}/select-pvp-winner`, data),
  ...
  // Matchmaking
  joinQueue: (betAmount) => api.post('/dice-roll-games/join-queue', { betAmount }),
